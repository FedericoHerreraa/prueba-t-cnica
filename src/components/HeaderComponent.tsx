        ...
        <header className="w-full">
                ...
                <div className="w-[75%] mx-auto flex justify-between items-center">
                    ...
                    <div className="w-2/3 flex justify-end items-center">
                        <div className="flex gap-10 items-center font-semibold text-sm">
                            ...
                            <p>Politicas</p>
                            <p>Contactenos</p>
                            <div className="px-3 py-2 bg-gray-100 rounded-md flex items-center gap-6">
                            ...
                            <div className="px-3 py-2 bg-gray-100 rounded-md flex items-center gap-3">
                                <p>Hola, Javier</p>
            ...
            <section className="w-full h-20 flex items-center bg-white">
                <div className="w-[75%] mx-auto flex items-center gap-4 text-sm">
                    <div className="flex-[1.5] flex items-center justify-around bg-gray-100 rounded-md px-5 py-3">
                    ...
                    <div className="flex-1 flex items-center justify-around bg-gray-100 rounded-md px-5 py-3">
